...
export default {
  ...
  async asyncData({ $axios }) {
    // Terms endpoint not implemented, using default data
    return {
      pageTitle: {
      ...
      chapters: [
        {
          name: 'General Terms',
          content: '<p>Welcome to DietManager. By using our service, you agree to these terms and conditions.</p>'
        },
        {
          name: 'Privacy Policy',
          content: '<p>We respect your privacy and protect your personal data in accordance with applicable laws.</p>'
        }
      ]
    }
    // return await $axios
