    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center">
            <h1 class="text-4xl font-semibold  pb-12">
                Your Personal AI Diet Manager <br>
                Transform Your Health Journey
            </h1>

            <p class="text-lg pb-12">
                Share your dietary goals and let our AI nutritionist create a personalized meal plan just for you.
            </p>
        </div>
        ...
        <div>
            @foreach($messages as $message)
                <!-- User -->
                @if($message['who'] === 'user')
                    <div class="bg-green-700 text-white rounded p-4 my-12">
        ...
        <p class="mt-8 text-sm">
            The diet manager running behind the scenes is built with the Neuron PHP framework. For more information, please visit
